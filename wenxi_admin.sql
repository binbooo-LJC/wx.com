...
Source Database       : wenxi_admin

Target Server Type    : MYSQL
Target Server Version : 50711
File Encoding         : 65001

Date: 2018-10-09 14:16:26
*/
...
-- ----------------------------
INSERT INTO `think_admin_user` VALUES ('1', 'admin', '67ad115fb2597e381fe3837a075ab3d7', '1', '2016-10-18 15:28:37', '2018-09-19 14:10:11', '127.0.0.1');
...
INSERT INTO `think_auth_rule` VALUES ('13', 'admin/project/index', '种类管理', '1', '1', '14', 'fa fa-sitemap', '0', '');
INSERT INTO `think_auth_rule` VALUES ('14', 'admin/Content/default', '种类管理', '1', '1', '0', 'fa fa-file-text', '56', '');
INSERT INTO `think_auth_rule` VALUES ('15', 'admin/consume/indexlist', '种类统计', '1', '1', '14', '', '0', '');
...
INSERT INTO `think_auth_rule` VALUES ('54', 'admin/Slide/default', '做工统计', '1', '1', '0', 'fa fa-wrench', '55', '');
INSERT INTO `think_auth_rule` VALUES ('55', 'admin/consume/sms', '短信通知', '1', '0', '54', '', '0', '');
INSERT INTO `think_auth_rule` VALUES ('56', 'admin/recharge/index', '账单统计', '1', '1', '54', '', '0', '');
INSERT INTO `think_auth_rule` VALUES ('57', 'admin/Consume/index', '做工记录', '1', '1', '54', 'fa fa-link', '0', '');
...
-- ----------------------------
-- Table structure for think_cash
-- ----------------------------
DROP TABLE IF EXISTS `think_cash`;
...
-- ----------------------------
INSERT INTO `think_consume` VALUES ('110', '84', '1', '100', '2018-08-02', '', '1');
INSERT INTO `think_consume` VALUES ('111', '84', '2', '500', '2018-08-02', '', '1');
INSERT INTO `think_consume` VALUES ('113', '85', '1', '1500', '2018-08-02', '', '1');
INSERT INTO `think_consume` VALUES ('114', '85', '2', '2000', '2018-08-02', '', '0');
INSERT INTO `think_consume` VALUES ('116', '84', '1', '200', '2018-08-02', '', '0');
INSERT INTO `think_consume` VALUES ('117', '86', '1', '200', '2018-08-02', '', '0');
...
-- ----------------------------
INSERT INTO `think_project` VALUES ('1', '长金鱼', '1.5', '件', '1');
INSERT INTO `think_project` VALUES ('2', '帽子', '0.5', '个', '1');
...
-- ----------------------------
INSERT INTO `think_recharge` VALUES ('2', '85', '2000', '2018-08-03 16:06:26', '');
INSERT INTO `think_recharge` VALUES ('3', '84', '400', '2018-08-03 17:06:30', '');
INSERT INTO `think_recharge` VALUES ('4', '85', '2000', '2018-09-17 23:19:23', '');
...
CREATE TABLE `think_user` (
  ...
  `balance` smallint(5) DEFAULT '0' COMMENT '余额',
...
-- ----------------------------
INSERT INTO `think_user` VALUES ('84', '李金城', '13366659939', '', '0', '2018-08-02', '1', '1');
INSERT INTO `think_user` VALUES ('85', 'lijincheng', '13366659939', '', '500', '2018-08-02', '2', '1');
INSERT INTO `think_user` VALUES ('86', '李', '18539981367', '', '0', '2018-08-02', '2', '1');

-- ----------------------------
-- Table structure for think_usertype
-- ----------------------------
DROP TABLE IF EXISTS `think_usertype`;
...
-- ----------------------------
-- Records of think_usertype
-- ----------------------------
INSERT INTO `think_usertype` VALUES ('1', '车工', '1');
